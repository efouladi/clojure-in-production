(ns clojure-in-production.middleware
  (:require [clojure-in-production.env :refer [defaults]]
            [cheshire.generate :as cheshire]
            [cognitect.transit :as transit]
            [clojure.tools.logging :as log]
            [clojure-in-production.layout :refer [*app-context* error-page]]
            ...
            [clojure-in-production.config :refer [env]]
